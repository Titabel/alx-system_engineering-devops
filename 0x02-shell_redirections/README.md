...
19. A to Z- > Replace all characters A and c from input to Z and e respectively.20. Without C, you will live in hiago- > Create a script that removes all letters c and C from input.
